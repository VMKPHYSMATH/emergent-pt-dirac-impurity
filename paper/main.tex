...
The same versioned code and data are prepared for public release in the GitHub
repository \texttt{emergent-pt-dirac-impurity}~\cite{kulkarni2026code}; the
repository will be activated when this revision is submitted.  The archived
